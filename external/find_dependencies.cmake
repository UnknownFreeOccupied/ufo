...
if(UFO_BUILD_TESTS)
	if(UFO_USE_SYSTEM_CATCH2)
		...
		if(TARGET Catch2::Catch2WithMain)
			...
			set(UFO_USE_SYSTEM_CATCH2 OFF)
		endif()
	endif()
	if(NOT UFO_USE_SYSTEM_CATCH2)
...
if(UFO_USE_SYSTEM_CLI11)
	...
	if(TARGET CLI11::CLI11)
		...
		set(UFO_USE_SYSTEM_CLI11 OFF)
	endif()
endif()
if(NOT UFO_USE_SYSTEM_CLI11)
...
if(UFO_BUILD_DOCS)
	...
	include("${CMAKE_CURRENT_LIST_DIR}/doxygen/doxygen-awesome.cmake")
endif()
